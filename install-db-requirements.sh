...
dmlutils==0.13.5 ; python_version >= "3.10" and python_version < "3.11"
...
google-cloud-bigquery-storage==2.31.0 ; python_version >= "3.10" and python_version < "3.11"
google-cloud-bigquery==3.30.0 ; python_version >= "3.10" and python_version < "3.11"
google-cloud-secret-manager==2.23.3 ; python_version >= "3.10" and python_version < "3.11"
greenlet==3.2.1 ; python_version >= "3.10" and python_version < "3.11" and (platform_machine == "aarch64" or platform_machine == "ppc64le" or platform_machine == "x86_64" or platform_machine == "amd64" or platform_machine == "AMD64" or platform_machine == "win32" or platform_machine == "WIN32")
