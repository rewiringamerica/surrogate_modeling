...
dmlutils==0.13.17 ; python_version == "3.10"
...
proto-plus==1.27.0 ; python_version == "3.10"
...
pywinpty==3.0.2 ; python_version == "3.10" and os_name == "nt"
