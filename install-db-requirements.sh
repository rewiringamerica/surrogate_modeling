...
dmlutils==0.10.17 ; python_version >= "3.10" and python_version < "3.11"
duckdb==1.2.1 ; python_version >= "3.10" and python_version < "3.11"
...
grpc-google-iam-v1==0.14.1 ; python_version >= "3.10" and python_version < "3.11"
...
pywin32==309 ; python_version >= "3.10" and python_version < "3.11" and platform_python_implementation != "PyPy" and sys_platform == "win32"
