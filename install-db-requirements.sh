...
db-dtypes==1.4.1 ; python_version >= "3.10" and python_version < "3.11"
distro==1.9.0 ; python_version >= "3.10" and python_version < "3.11"
dmlbootstrap==0.2.0 ; python_version >= "3.10" and python_version < "3.11"
dmlutils==0.10.14 ; python_version >= "3.10" and python_version < "3.11"
duckdb==1.2.0 ; python_version >= "3.10" and python_version < "3.11"
...
google-cloud-bigquery-storage==2.28.0 ; python_version >= "3.10" and python_version < "3.11"
google-cloud-bigquery==3.29.0 ; python_version >= "3.10" and python_version < "3.11"
google-cloud-secret-manager==2.23.1 ; python_version >= "3.10" and python_version < "3.11"
greenlet==3.1.1 ; python_version >= "3.10" and python_version < "3.11" and (platform_machine == "aarch64" or platform_machine == "ppc64le" or platform_machine == "x86_64" or platform_machine == "amd64" or platform_machine == "AMD64" or platform_machine == "win32" or platform_machine == "WIN32")
grpc-google-iam-v1==0.14.0 ; python_version >= "3.10" and python_version < "3.11"
h3==4.2.1 ; python_version >= "3.10" and python_version < "3.11"
...
proto-plus==1.26.0 ; python_version >= "3.10" and python_version < "3.11"
...
pywin32==308 ; python_version >= "3.10" and python_version < "3.11" and platform_python_implementation != "PyPy" and sys_platform == "win32"
...
shapely==2.0.7 ; python_version >= "3.10" and python_version < "3.11"
...
usaddress==0.5.11 ; python_version >= "3.10" and python_version < "3.11"
